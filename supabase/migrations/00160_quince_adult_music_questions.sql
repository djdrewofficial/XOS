-- Quince Party template — "Adult / Parents Music Requests" section questions
-- (from the live Vibo template): clean-edits preference + group dances.
...
begin
  ...
  select id into sec from planning_template_sections
    where template_id = t_id and title = 'Adult / Parents Music Requests' limit 1;
