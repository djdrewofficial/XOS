...
export default async function AssistantSettingsPage() {
  ...
  return (
    <div className="max-w-4xl">
      <h1 className="page-title mb-2">AI</h1>
      ...
      <Tabs
        tabs={[
          { id: "tasks", label: "Daily Tasks", badge: tasks.length || undefined, content: tasksTab },
          { id: "kb", label: "Knowledge Base", badge: list.length || undefined, content: kbTab },
        ]}
      />
    </div>
  );
