...
import { updateAddonSettings, deleteAddon, saveAddonEquipmentDefaults, saveAddonPlanningSections } from "@/app/(app)/packages/actions";
...
export default async function AddonDetailPage({
  ...
  const [{ data: addon }, { data: categories }, { data: equipDefaults }, { data: items }, { data: systems }, { count: usedCount }, { data: templateSections }, { data: assignedSections }] =
    await Promise.all([
    ...
    <div className="max-w-6xl">
      ...
      <Tabs
        tabs={[
          ...
          { id: "sections", label: "Planning Sections", badge: (assignedSections ?? []).length || undefined, content: sectionsTab },
